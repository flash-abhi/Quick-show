    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <p className=''>{timeFormat(show.movie.runtime)} * {show.movie.genres.map(genre => genre.name).join(", ")} * {show.movie.release_date.split("-")[0]}
            </p> 
      ...
      <p className='text-lg font-mc'>Your Favorite Cast</p>
